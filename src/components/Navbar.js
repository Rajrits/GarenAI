      ...
      <div className=" hidden sm:block text-sm font-medium text-center w-[80%] mt-5 text-gray-500 border-b border-gray-200 ">
        <ul className="flex space-x-16 justify-end mr-5 font-semibold">
          ...
          <Link to='/about' className="me-2">
            ...
            <button onClick={() => setTabs("About")} className={`inline-block p-4 ${tabs === 'About' ? "text-blue-600  border-blue-600 active" : "border-transparent hover:text-gray-600  hover:border-gray-300"} border-b-2 rounded-t-lg `} aria-current="page">About us</button>
          </Link >


          <Link to='/chat' className='mt-2 flex justify-center items-center space-x-2 text-white bg-gradient-to-r from-green-300 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2'>
